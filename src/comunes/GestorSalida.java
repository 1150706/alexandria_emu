...
public class GestorSalida {
    ...
    public static void GAME_SEND_KODE(Jugador perso, String str)
    {
        ...
        send(perso, packet);
        if(MainServidor.CONFIG_DEBUG)
            JuegoServidor.addToSockLog((new StringBuilder("Game: Send>>")).append(packet).toString());
    }
	...
	public static void GAME_SEND_EHP_PACKET(Jugador out, int templateID)	//Packet d'envoie du prix moyen du template (En réponse a un packet EHP)
	{
	...
	public static void GAME_SEND_EHL_PACKET(Jugador out, int categ, String templates)	//Packet de listage des templates dans une catégorie (En réponse au packet EHT)
	{
